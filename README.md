...
| `!statusview <on\|off>` | Activa/desactiva que este socket marque automáticamente los estados (historias) de sus contactos como vistos. Ajuste por socket, uso libre |
