...
const settings = {
  ...
  // --- APIS EXTERNAS ---
  apis: {
    apicausas: process.env.APICAUSAS_KEY || "causa-4148c87379edfd97", // https://rest.apicausas.xyz — usada por !fb/!tiktok/!instagram (v1) y !ytmp3/!ytmp4 (v2)
    alyacore: process.env.ALYACORE_KEY || "Duarte-zz12", // https://api.alyacore.xyz
  },
  ...
  bot: {
    ...
    tertiaryOwnerNumber: process.env.TERTIARY_OWNER_NUMBER || "18096758983", // Número terciario (Nevi)
    // Lista de números owner. Acepta cualquier cantidad separados por coma en la variable de entorno OWNER_NUMBERS.
    // Ej: OWNER_NUMBERS=5354185002,522441357601,18096758983
    ownerNumbers: (process.env.OWNER_NUMBERS || "5354185002,522441357601,18096758983")
      .split(",")
      .map((n) => n.trim())
      .filter(Boolean),
  },
